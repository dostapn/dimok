class FlavorsController < ApplicationController
  ...
  before_action :set_flavor_groups, only: [:new, :create, :edit, :update]
  ...
  private
  def set_flavor_groups
    @flavor_groups = FlavorGroup.all.pluck(:name, :id)
  end

  # Use callbacks to share common setup or constraints between actions.
  def set_flavor
    @flavor = Flavor.find_by_mnemonic!(params[:id])
  end

  # Never trust parameters from the scary internet, only allow the white list through.
  def flavor_params
    params.require(:flavor).permit(:name, :mnemonic, {flavor_group_ids: []}, :poster)
  end
end
